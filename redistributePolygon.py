...
#
def calculate_field_proportion_based_on_combination(field_to_calculate, total_properties_field, local_number_of_properties_field, total_area_field):
	"""
	...
	arcpy.CalculateField_management (intersecting_polygons, field_to_calculate, "return_average_value(!"+total_properties_field+"!, !"+local_number_of_properties_field+"!, !" + field_to_calculate + "!, !" + total_area_field + "!, !Shape_Area!)", "PYTHON_9.3", """def return_number_proportion_of_total(total_properties, local_properties, field_to_calculate):
	new_value =  (float(local_properties)/total_properties) * field_to_calculate
	return int(new_value)
...
add_property_count_to_layer_x_with_name_x(data_layer, "GMZ_counted_prop")
